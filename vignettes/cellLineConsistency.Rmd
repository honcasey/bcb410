...
First, we use the *PharmacoGx* package to download and intersect the two PharmacoSets based on their common cell lines and drugs.
...
```
![](~/cellLineConsistency/vignettes/plotCorrelations-example.png)
<br>
